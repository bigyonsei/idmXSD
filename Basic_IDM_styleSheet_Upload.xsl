    ...
    <xsl:template name="informationUnit">
        <div class="page">
            <table class="con_table" style="width: 789px; border-collapse:collapse;">
                <!--Information Unit 이름-->
                <tr>
                    <th colspan="3" style="width: 789px; " ><xsl:value-of select="@informationUnitName"/></th>
                </tr>
                <!--Information Unit 설명-->
                <tr>
                ...
                <xsl:for-each select="graphicalExample">
                    <td style="width=66%; background-color:white">
                        ...
                        <img width="auto" height="100px"><xsl:attribute name="src">
                            <xsl:value-of select="@graphicalExampleFullFilePath"/>
                                </xsl:attribute>
                        </img>
                    ...
                    <xsl:for-each select="subInformationUnit/informationUnit">
                        <td style="background-color:white; vertical-align:top;">
                            <table class="con_table" style="width: 260px; height: auto; background-color:white; height: px; border-collapse: collapse;">
                                <!--이름-->
                                <tr>
                                    <td colspan="2" style="padding-left:10px; font-size: 12pt; font-family: 'Bebas Neue', cursive; padding-top:10px; text-align:left; background-color:white; border-color: white;"><xsl:value-of select="@informationUnitName"/></td>
                                </tr>
                                <!--설명-->
                                <tr>
                                ...
                                <td style="background-color:white;border-color:white;"></td>
                                    <td style="color:#91C9D5; font-size:8px; text-align:left; background-color:white;border-color: white;">example:<xsl:value-of select="@textualExampleDescription"/></td>
                                </tr>
                                </xsl:for-each>
                                <!--이미지 예시-->
                                <xsl:for-each select="graphicalExample">
